...
if (cards.length > 2) {
    ...
    thirdCard.prepend(`
        <div class="relative h-72 overflow-hidden bg-white flex justify-center items-center opacity-95 hover:opacity-100 transition-opacity border-b border-slate-100 dark:border-slate-800">
            <img src="assets/product3.png" alt="P-80+ Adhesive description" class="h-full w-full object-cover object-right-top hover:scale-105 transition-transform duration-500 cursor-pointer">
...
console.log("Success! Third product flyer attached.");
